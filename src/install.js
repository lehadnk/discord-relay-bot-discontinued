...
db.run("CREATE TABLE participants (id INTEGER PRIMARY KEY AUTOINCREMENT, discord_id TEXT, discord_server_id TEXT, name TEXT, parsed_name TEXT, image_url TEXT)");
